...
Selector::Type Selector::type() const { return m_type; }

const CSS::CSSOMString& Selector::value() const { return m_value; }

Selector::Combinator Selector::combinator() const { return m_combinator; }

Selector::MatchType Selector::matchType() const { return m_match_type; }

const CSS::CSSOMString& Selector::matchValue() const { return m_match_value; }
